        ...
        <nav class="navbar navbar-expand-lg">
          <div class="search-panel">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout">                   <a id="logout" href="{{ route('logou') }}"
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
          ...
          <ul class="list-unstyled">
                  <li class="activ"><a href="{{ route('home') }}"> <i class="icon-home"></i>Home </a></li>
                  <li><a href="{{ route('membership') }}"> <i class="icon-grid"></i>Membership </a></li>
                  <li><a href="{{ route('edit') }}"> <i class="icon-user"></i>Edit Profile </a></li>
                  {{-- <li><a href="{{ route('settings') }}"> gear Settings </a></li> --}}
                  <li><a href="{{ route('info') }}"> <i class="icon-padnote"></i>Payment Info </a></li>
                
                </ul><span class="heading">Finance</span>

                  <li><a href="{{ route('withdraw') }}"> <i class="icon-padnote"></i>Withdrawal & History</a></li>
          ...
          <ul class="list-unstyled">
            <li> <a href="{{ route('contact') }}"> <i class="icon-settings"></i>Contact </a></li>
            <li> <a href="{{ route('notify') }}"> <i class="icon-settings"></i>Notification </a></li>
